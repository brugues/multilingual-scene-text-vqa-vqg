...
def main():
    ...
    print(cosine_similarity(np.expand_dims(np.dot(wiki_ca_matrix, ca), axis=0), np.expand_dims(ca_al, axis=0)))
    print(cosine_similarity(np.expand_dims(np.dot(wiki_ca_matrix.T, ca), axis=0), np.expand_dims(ca_al, axis=0)))
    print(cosine_similarity(np.expand_dims(np.dot(ca, wiki_ca_matrix), axis=0), np.expand_dims(ca_al, axis=0)))
    print(cosine_similarity(np.expand_dims(np.dot(ca, wiki_ca_matrix.T), axis=0), np.expand_dims(ca_al, axis=0)))

    print(cosine_similarity(np.expand_dims(np.dot(wiki_ca_matrix, ca_bin), axis=0), np.expand_dims(ca_al, axis=0)))
    print(cosine_similarity(np.expand_dims(np.dot(wiki_ca_matrix.T, ca_bin), axis=0), np.expand_dims(ca_al, axis=0)))
    print(cosine_similarity(np.expand_dims(np.dot(ca_bin, wiki_ca_matrix), axis=0), np.expand_dims(ca_al, axis=0)))
    print(cosine_similarity(np.expand_dims(np.dot(ca_bin, wiki_ca_matrix.T), axis=0), np.expand_dims(ca_al, axis=0)))
