...
#     quit()
checkpoint_path = 'models/cvc_ckpt/saved_model_conv_1x1_epoch75.ckpt'
...
data_generator = STVQADataGenerator(gt_file_test, maxlen, image_path, img_size, fasttext_model, batch_size=batch_size,
