...
#python train_olra.py --n_epochs 15 --fasttext_subtype cc --output_folder olra_b15_no_att
#python train_olra.py --n_epochs 30 --fasttext_subtype cc --output_folder olra_b30_no_att

#python train_olra.py --n_epochs 15 --fasttext_subtype cc --multimodal_attention --output_folder olra_b15_att
#python train_olra.py --n_epochs 30 --fasttext_subtype cc --multimodal_attention --output_folder olra_b30_att

#python train_olra.py --n_epochs 15 --fasttext_subtype cc --multimodal_attention --lr 0.00005 --output_folder olra_b15_att_lrhalf
#python train_olra.py --n_epochs 30 --fasttext_subtype cc --multimodal_attention --lr 0.00005 --output_folder olra_b30_att_lrhalf
